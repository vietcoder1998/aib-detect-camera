                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-left">
                    <span className="text-gray-600 block">
                      {t('productPage.hero.model')}
                    </span>
                    <span className="font-semibold text-gray-900">
                      {t('productPage.hero.modelValue')}
                    </span>
                  </div>
                  <div className="text-left">
                    <span className="text-gray-600 block">
                      {t('productPage.hero.company')}
                    </span>
                    <span className="font-semibold text-gray-900">
                      {t('productPage.hero.companyValue')}
                    </span>
                  </div>
                  <div className="text-left">
                    <span className="text-gray-600 block">
                      {t('productPage.hero.origin')}
                    </span>
                    <span className="font-semibold text-gray-900">
                      {t('productPage.hero.originValue')}
                    </span>
                  </div>
                </div>
                <Button
                  variant="primary"
                  className="mt-3 bg-red-600 hover:bg-red-700 border-red-600 hover:border-red-700 text-sm py-2"
                >
