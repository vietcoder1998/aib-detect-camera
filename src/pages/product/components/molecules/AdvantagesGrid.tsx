  ...
  const advantages = [
    {
      ...
      description: t(
        'productPage.advantagesGrid.advantages.reducedManpower.description'
      ),
      color: 'text-red-600',
    },
    {
      ...
      description: t(
        'productPage.advantagesGrid.advantages.earlyDetection.description'
      ),
      color: 'text-blue-600',
    },
    {
      icon: Shield,
      title: t(
        'productPage.advantagesGrid.advantages.reducedFalseAlerts.title'
      ),
      description: t(
        'productPage.advantagesGrid.advantages.reducedFalseAlerts.description'
      ),
    ...
    },
    {
      icon: Zap,
      title: t(
        'productPage.advantagesGrid.advantages.enhancedProactivity.title'
      ),
      description: t(
        'productPage.advantagesGrid.advantages.enhancedProactivity.description'
      ),
