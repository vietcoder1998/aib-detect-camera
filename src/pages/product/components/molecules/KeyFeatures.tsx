      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="p-8 hover:shadow-lg transition-all duration-300 border-l-4 border-transparent hover:border-red-600"
            >
              <div
                className={`w-12 h-12 rounded-lg bg-gray-50 mb-6 flex items-center justify-center`}
              >
